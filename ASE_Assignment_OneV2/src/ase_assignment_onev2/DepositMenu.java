...
public class DepositMenu extends javax.swing.JDialog {
     ...
     */
    public DepositMenu(java.awt.Frame parent, boolean modal, Customers customer) {
        super(parent, modal);
        initComponents();
    ...
    private void depositButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_depositButtonActionPerformed
        ...
        if (amountField.getText().isEmpty()) {
            ...
            try {
                ...
                int result = JOptionPane.showConfirmDialog(this, "Deposit £" + String.format("%.2f", amount) + " to the account?\nInterest Earned: £" + String.format("%.2f", (customer.getAcc().getInterest() * amount)));
                if (result == JOptionPane.OK_OPTION) {
                    try {
                        //Make the deposit
                        customer.getAcc().deposit(amount);
                        this.dispose();
                    } catch (InvalidAmountEx ex) {
